...
const Hero = () => {
  return (
    <>
      <section>
        <div className='bg-[#495d57] flex flex-col md:flex-row w-full md:items-start items-center h-[775px] md:h-[420px] justify-between px-12 md:px-4 xl:px-32 2xl:px-80 py-12'>
          <div className='font-semibold text-white'>
            <h1 className='text-6xl text-yellow-400 mb-2'>Little Lemon</h1>
            <h2 className='text-4xl mb-6'>Chicago</h2>
            <p className='text-2xl w-80 md:w-90 mb-4'>We are a family owned Mediterranean restaurant, focused on traditional recipes served with a modern twist.</p>
            <Link to='/reserve'>
