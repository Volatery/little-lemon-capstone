...
const Hero = () => {
  return (
    <>
      <section>
        <div className='bg-[#495d57] flex flex-col lg:flex-row w-full lg:items-start items-center h-[725px] lg:h-[400px] justify-between px-12 lg:px-24 xl:px-32 2xl:px-80 py-12'>
