          ...
          <Form className="w-full max-w-md">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-4">
              <div className="grid">
                ...
                />
                <div className="text-red-600" style={{ opacity: errors.date && touched.date ? 1 : 0 }}>
                  {errors.date}
                </div>
              </div>
              <div className="grid">
                ...
                <Field
                  ...
                  className="bg-white rounded p-2"
                />
                <div className="text-red-600" style={{ opacity: errors.numberOfDiners && touched.numberOfDiners ? 1 : 0 }}>
              ...
              <div className="grid">
                ...
                <Field as="select" id="occasion" name="occasion" className="bg-white rounded p-2">
                  <option value="">Select an occasion</option>
                  <option value="Birthday">Birthday</option>
                  <option value="Anniversary">Anniversary</option>
                </Field>
                <div className="text-red-600" style={{ opacity: errors.occasion && touched.occasion ? 1 : 0 }}>
                  {errors.occasion}
                </div>
              </div>
              <div className="grid">
                ...
                <Field
                  ...
                  name="time"
                  className="bg-white rounded p-2"
                  onChange={handleChange} // Update handleChange when a new time is selected
                >
                ...
                <div className="text-red-600" style={{ opacity: errors.time && touched.time ? 1 : 0 }}>
                  {errors.time}
                </div>
              </div>
            </div>
